            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between py-4">
                <div class="flex items-center justify-between">
                    <div class="flex items-center">
                        ...
                        <div>
                            <h1 class="font-heading text-xl font-bold">Gizi Lombok Utara</h1>
                        </div>
                    </div>
                ...
                <!-- Navigation -->
                <nav id="mobileMenu" class="hidden md:flex flex-col md:flex-row md:items-center mt-4 md:mt-0 space-y-2 md:space-y-0 md:space-x-1">
    ...
    <div class="bg-white border-b border-gray-200">
        <div class="container mx-auto px-4 py-5">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                <div>
                    <h1 class="font-heading text-2xl font-bold text-gray-900">@yield('page-title', 'Dashboard')</h1>
        ...
        <div class="container mx-auto px-4 py-6">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                <div class="mb-4 md:mb-0">
                    ...
                    <p class="text-gray-600 text-sm mt-1">© {{ date('Y') }} Dinas Kesehatan Lombok Utara. All rights reserved.</p>
                </div>
